...
(function () {
    ...
    $(document).ready(function () {
        var links = [
		    ...
		    {
                name: 'dreamybull',
                link: 'https://twitter.com/dreamybullxxx?lang=en'
            },
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=2bdc619693544329841a3196dca3f6c0', function (data) { 
            ...
            writeLine(["Starting.. Opening... ", "Granting connection to <span style='font-size: 14px; color: #FF0000;'>[dreamybull.ga]</span>..."], 30, function () {
                ...
                writeLine(["Permission granted <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Loading site...."], 30, 501, function () {
                    ...
                    writeLine(["<i style='color: #FFFF00'>welcome, make sure to blow!</i>"], 30, 500, function () {
